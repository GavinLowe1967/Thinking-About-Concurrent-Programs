...
\end{scala}
%
Each |pick| and |drop| channel is shared between two philosophers; this
sharing removes the need for an alternation.
%
...
%philosophers is holding the fork, the other cannot pick it up.  
%% However, such
