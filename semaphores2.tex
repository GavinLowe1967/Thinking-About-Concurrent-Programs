...
thread is in the best position to decide which thread can run next.  We will
use the technique again in later examples.

There are two important things to remember when passing the baton.
%
\begin{enumerate}
\item
...
technique of passing the barrier.  
...
\end{scala}
\caption{An implementation of a barrier synchronisation using sem\-a\-phores.}
