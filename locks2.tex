...
class ShardedSet[A](shards: Int) extends Sharding[K](shards) with Set[A]{
...
Figure~\ref{fig:Sharding} defines the |shardFor| function, which we will
discuss shortly: we will reuse this class later.
%% gives some supporting code
...
\begin{figure}
\begin{scala}
/** Class to support sharding, using £shards£ shards, with keys of type £A£. */
...
\end{scala}
\caption{Class providing support for sharding.}
\label{fig:Sharding}
\end{figure}
