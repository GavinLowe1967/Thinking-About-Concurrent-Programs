...
\input{Exercises/distribution} % messaging system built on a ring.

\input{Exercises/ringFold} % fold of values in a ring 

\input{Exercises/distTermination} % distributed termination

\input{Exercises/atomicBroadcastHeap} % atomic broadcast using a heap

\input{Exercises/gridMax} % maximum in a 2D grid
