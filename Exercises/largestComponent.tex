...
\end{array}
\]
\caption{An example image (left), and its index array (right) for the largest
...
Here is an outline of a sequential algorithm to find  the largest connected
component.  
%
\begin{description}
...
on the previous round and the current round, respectively; the roles are
swapped at the end of each round.  A combining barrier is used to coordinate
and to decide termination.
