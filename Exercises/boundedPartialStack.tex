\begin{questionS}
\label{ex:boundedPartialStack}
Use a monitor to implement a bounded partial stack with signature
\begin{scala}
...
\end{scala}
%
As with the bounded partial queue in the body of the chapter, we should choose
a fairly small value for |bound|, to ensure coverage of the case when the
stack becomes full.
\end{answerS}
