...
\item Now suppose we remove the condition that messages may be sent only
  upwards and rightwards: instead you may define channels however you like.
  Write code to again find the maximum value, but that runs in time $O(\log
  n)$.
\end{enumerate}
\end{question}
