...
current contents of the stack.  (Section~\ref{sec:scala-types} describes the
  basics of the |List| class in Scala.)
...
|Option[Int]| contains the union of such values; see
Section~\ref{sec:scala-types}.)  This combines the |isEmpty| and |pop|
operations from the given class.  Client code can treat the result
